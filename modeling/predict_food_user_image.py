...
def predict_food_user_single_image(image_path, model_path):
    ...
    transform = get_validation_transforms(
        image_size
    )  #  image transformations (should match the preprocessing used in training)
    # =======
    ...
    get_nutrition_info(predicted_food_string, weight_grams=False)
...
aa_test_guac_image_path = os.path.expanduser(
    "~/Documents/GitHub/photomacros/all_user_phone_test_images/london_burger.jpeg"
)
aa_test_guac_image_path = os.path.expanduser(
    "~/Documents/GitHub/photomacros/all_user_phone_test_images/burger.jpeg"
)
# aa_test_guac_image_path = os.path.expanduser("~/Documents/GitHub/photomacros/all_user_phone_test_images/Nachos3.jpg")
aa_test_guac_image_path = os.path.expanduser(
    "~/Documents/GitHub/photomacros/all_user_phone_test_images/guac.jpeg"
)
